...
export default function StoryReview({ storyState, onReset, onEdit, onBack, userId }: StoryReviewProps) {
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <Button 
                ...
                size="lg"
                className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white border-0 shadow-xl py-6 text-lg font-bold"
              >
                Edit Character
              </Button>
              <Button 
                onClick={() => onEdit("plot")} 
                size="lg"
                className="bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white border-0 shadow-xl py-6 text-lg font-bold"
              >
                Edit Plot
              </Button>
            </div>
